 		...
 		return this.each(function () {
 			if (opts.destroy == true) {
 				...
 				if ($(this).attr("longdesc")) {
 					...
 					var icon = $("<div></div>").addClass("fullsize-icon").css({
 							"display" : "none"
 						});
 					var addTrigger;
 					...
 					$(icon).click(function () {
 						...
 						$(full_img).load(function () {
 							...
 							$(this).css({
 								"height" : org_image.height() + "px",
 								"width" : org_image.width() + "px"
 							});
 							...
 							if (img_title != "" || opts.forceTitleBar == true) {
 								...
 								var full_title = $("<div></div>").addClass("fullsize-title").css({
 										"max-width" : img_w
 									});
