...
function block(username) {
	$.post( "chat.php?action=block", { username: username }, function(data) {
        //alert(data);
...
function createChatBox(chatboxtitle,minimizeChatBox) {
	...
	'<a href="javascript:void(0)" onclick="javascript:webcam(\''+chatboxtitle+'\');"><img src="images/webcam.png" alt="Close Chat" /></a>'+
	'<div class="chatboxoptions"><a href="javascript:void(0)" onclick="javascript:toggleChatBoxGrowth(\''+chatboxtitle+'\')"><img src="images/ui_buttons.png" alt="Close Chat" /></a> <a href="javascript:void(0)" onclick="javascript:closeChatBox(\''+chatboxtitle+'\')"><img src="images/close.png" alt="Close Chat" /></a></div>'+
	'<a href="javascript:void(0)" onclick="javascript:block(\''+chatboxtitle+'\');"><img src="images/block-icon.png" alt="Block User" /></a> '+
...
message = $(chatboxtextarea).val();
		...
		if (message != '') {
			$.post("chat.php?action=sendchat", {to: chatboxtitle, message: message , action:action} , function(data){
